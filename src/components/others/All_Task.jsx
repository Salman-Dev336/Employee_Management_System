...
const All_Task = () => {
  ...
  return (
    <div className=" bg-linear-to-r from-[#0f0c29] via-[#302b63] to-[#24243e] backdrop-blur-lg border border-white/10 shadow-2xl  mt-2 rounded-3xl h-72 ">
      <div className="bg-linear-to-r from-purple-900 to-indigo-900 py-4 px-6 flex justify-between items-center rounded-2xl ">
     ...
     <div className="h-[80%] overflow-auto">
       {userdata.map(function (e , index) {
        return (
          <div key={index} className="bg-linear-to-r from-purple-900 to-indigo-900  py-4 px-6 mt-2 flex justify-between items-center rounded-2xl  ">
